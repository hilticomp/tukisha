...
import com.artitech.tsalano.tukisha.model.EskomHistoryModel;
...
public class MunicipalityTransactionHistoryActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MunicipalityTransactionHistoryActivity.this, MainActivity.class);
                startActivity(i);
            }
        });
    ...
    public void onClick(View v) {
        ...
        new DatePickerDialog(MunicipalityTransactionHistoryActivity.this, this, myCalendar
    ...
    private void loadTransactionHistory(String startdate, String enddate) {
        ...
        client.get("https://munipoiapp.herokuapp.com/api/app/municipalitytransactionhistory?agentid=" + tukishaApplication.getAgentID() + "&startdate=" + startdate  + "&enddate=" + enddate, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int status, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    if (status == 200) {
                        ...
                        Gson gson = new Gson();
                        EskomHistoryModel transactionHistoryModel = gson.fromJson(response, EskomHistoryModel.class);
                       ...
                       /* TransactionHistoryModel[] transactionHistoryModel = new TransactionHistoryModel[]{new TransactionHistoryModel("Relay", "1234567", "21 Aug 2017", "R200", "Clothing Account", "Foschini"),
                            ...
                            */
                        if (transactionHistoryModel.getResults().size() > 0) {

                            listItems = new ArrayList<ElectricityVoucherModel>();

                            for (int i = 0; i < transactionHistoryModel.getResults().size(); i++) {

                                listItems.add(transactionHistoryModel.getResults().get(i));

                            }

                            transactionListView = (ListView) findViewById(R.id.listv);

                            MunicipalityListAdapter adapter = new MunicipalityListAdapter(getApplicationContext(), R.layout.list_transaction_layout, R.id.item_ProductType, listItems);
                            ...
                            transactionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView parent, View view,
                                    ...
                                    ElectricityVoucherModel voucher = (ElectricityVoucherModel) transactionListView.getItemAtPosition(position);

                                    Intent i = new Intent(MunicipalityTransactionHistoryActivity.this, SendSMSActivity.class);
                                    i.putExtra("vouchernumber", voucher.getTokenNumber());
                                    i.putExtra("amount", voucher.getTokenAmount());
