                ...
                try {
                    ...
                    if (status == 200) {
                        ...
                        if (transactionHistoryModel.length > 0) {
                            ...
                            ListAdapter adapter = new ListAdapter(getApplicationContext(), R.layout.list_transaction_layout, R.id.item_ProductType, listItems);
                            ...
                            transactionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView parent, View view,
                                    ...
                                    final ProgressDialog progressDialog = new ProgressDialog(TransactionHistoryActivity.this);
                                    progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
